export default {
  ...
  rooms: {
    ...
    createPrivate: '私有房间',
    privateAccessTitle: '加入私有房间',
    privateAccessDesc: '验证成功后，此浏览器会在短时间内保持访问权限。',
    password: '房间密码',
    newRoomPassword: '设置房间密码',
  ...
  settings: {
    ...
    currentRoom: '当前房间',
    roomName: '房间名称',
    keepRoomPassword: '留空以保留当前密码',
    keepExistingPassword: '保留现有密码',
    saveRoom: '保存房间',
    saving: '保存中...',
    roomSaveFailed: '无法保存房间设置',
    invites: {
      nav: '邀请码',
      title: '邀请码',
    ...
    account: {
      ...
      security: '账号安全',
      adminPasswordAccess: '该平台管理员账号使用用户名和密码登录，可在管理员登录入口重新验证身份。',
      inviteMemberAccess: '该成员账号由邀请码创建，不提供独立密码登录或修改密码。',
      guestAccess: '访客身份仅保存在当前浏览器会话中；如需跨设备保存数据，请使用邀请码加入。',
      browserSession: '登录状态由当前浏览器的安全会话 Cookie 保护。退出后需要重新加入或登录。',
      logout: '退出登录',
    ...
    admin: {
      ...
      adminToolsDesc: '管理用户授权、房间工具和平台服务。',
      userAccessAndLive: '用户授权与房间工具',
      localTracks: '曲目列表',
      running: '执行中...',
      passwordRequired: '请先使用管理员账号登录',
      commandExecuted: '管理员操作已完成',
      commandFailed: '权限不足或操作失败',
